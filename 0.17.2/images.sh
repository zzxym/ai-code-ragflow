...
echo 'ragflow v0.17.2 镜像tag'
docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/ragflow:v0.17.2 infiniflow/ragflow:v0.17.2
...
echo 'ragflow v0.17.2 镜像tag完成'

echo 'ragflow v0.17.2 删除yunaiai镜像'
docker rmi crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/ragflow:v0.17.2
docker rmi crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/valkey:8
docker rmi crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/mysql:8.0.39
